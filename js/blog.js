...
$(function(){
    var numberOfItems = $(".section-body-container .card-blog").length;
    ...
    function showPage(whichPage){
        if(whichPage < 1 || whichPage > totalPages) return false;
         ...
         $(".section-body-container .card-blog").hide().slice((currentPage - 1) * limitPerPage, currentPage * limitPerPage).show();
